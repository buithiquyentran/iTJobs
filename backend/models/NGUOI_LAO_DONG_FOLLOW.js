...
const NGUOI_LAO_DONG_FOLLOW = sequelize.define("NGUOI_LAO_DONG_FOLLOW", {
  MA_NLD: { type: DataTypes.INTEGER, primaryKey: true, references: { model: NguoiLaoDong, key: "MA_NLD" } },
  MA_NTD: { type: DataTypes.INTEGER, primaryKey: true , references: { model: NhaTuyenDung, key: "MA_NTD" }},
  TRANG_THAI: { type: DataTypes.BOOLEAN, defaultValue: false },
},
{
